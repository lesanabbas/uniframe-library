...
const Layout = ({ children }: LayoutProps ) => {
  return (
    <div className="min-h-screen bg-black text-white">
      <nav className="w-full h-14 py-6 px-8 flex items-center justify-between fixed top-0 left-0 z-10 backdrop-blur-sm bg-black/30">
        ...
        <div className="hidden md:flex space-x-8">
          <Link href="/docs" className="text-lg font-medium hover:text-[#8A9A5B]">
            Docs
          </Link>
          <Link href="/playground" className="text-lg font-medium hover:text-[#CB6D51]">
            Playground
          </Link>
          <Link href="/guides" className="text-lg font-medium hover:text-[#CB6D51]">
            Guides
          </Link>
          <Link href="#" className="text-lg font-medium hover:text-[#CB6D51]">
            Blog
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-6">
          <a href="https://github.com" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-white hover:text-[#CB6D51] transition">
